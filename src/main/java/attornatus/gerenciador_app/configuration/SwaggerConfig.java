...
public class SwaggerConfig {
    ...
    private static final String BASE_PACKAGE = "gerenciador-pessoas";
    private static final String API_TITLE = "Gerenciador Pessoas API";
    private static final String API_DESCRIPTION = "REST API para gerencimento de Pessoas";
